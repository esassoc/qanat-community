...
export class GeospatialDataCreateComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.externalMapLayer$ = combineLatest({ geography: this.geography$, routeParams: this.route.params }).pipe(
            switchMap(({ geography, routeParams }) => {
                ...
                return this.externalMapLayerService.geographiesGeographyIDExternalMapLayerExternalMapLayerIDGet(geography.GeographyID, externalMapLayerID);
            }),
            tap((dto) => {
    ...
    onSubmit(geography: GeographyMinimalDto): void {
        ...
        const submitRequest = this.isCreating
            ? this.externalMapLayerService.geographiesGeographyIDExternalMapLayersPost(geography.GeographyID, this.formGroup.value)
            : this.externalMapLayerService.geographiesGeographyIDExternalMapLayersPut(geography.GeographyID, this.formGroup.value);
