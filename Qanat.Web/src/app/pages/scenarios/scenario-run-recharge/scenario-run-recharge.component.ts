...
import { ModelSimpleDto, RechargeScenarioDto, ScenarioObservationPointDto, ScenarioPumpingWellDto, ScenarioRechargeSiteDto } from "src/app/shared/generated/model/models";
...
export class ScenarioRunRechargeComponent implements OnInit, OnDestroy {
    ...
    public onMapMarkerSelection(selectedMapObject: ScenarioRechargeSiteDto | ScenarioObservationPointDto | ScenarioPumpingWellDto) {
        ...
        } else if (selectedMapObject instanceof ScenarioObservationPointDto) {
