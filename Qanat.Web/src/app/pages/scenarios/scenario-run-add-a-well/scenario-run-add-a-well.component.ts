...
import { ModelSimpleDto, ScenarioObservationPointDto, ScenarioPumpingWellDto, ScenarioRechargeSiteDto } from "src/app/shared/generated/model/models";
...
export class ScenarioActionAddAWellComponent implements OnInit, OnDestroy {
    ...
    public onMapMarkerSelection(selectedMapObject: ScenarioPumpingWellDto | ScenarioObservationPointDto | ScenarioRechargeSiteDto) {
