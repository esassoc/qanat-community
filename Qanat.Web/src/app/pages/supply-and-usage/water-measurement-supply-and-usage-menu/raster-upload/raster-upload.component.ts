...
export class RasterUploadComponent {
    ...
    public unitTypeSelectOptions: SelectDropdownOption[] = UnitTypesAsSelectDropdownOptions;
    ...
    public onSubmit(geographyID: number): void {
        ...
        this.waterMeasurementService.uploadRasterWaterMeasurement(geographyID, this.fileUpload, this.unitTypeID, this.waterMeasurementTypeID, effectiveDate).subscribe({
            next: (response) => {
                this.isLoadingSubmit = false;
