...
export class ParcelAdminPanelComponent implements OnInit {
    ...
    constructor(private modalService: ModalService, private parcelService: ParcelService, private route: ActivatedRoute, private customAttributeService: CustomAttributeService) {}
