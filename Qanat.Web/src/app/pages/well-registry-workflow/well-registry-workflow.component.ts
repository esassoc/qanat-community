...
@Component({
    ...
    imports: [GeographyLogoComponent, WellRegistryWorkflowNavComponent, WellRegistryWorkflowProgressComponent, RouterOutlet, WellRegistryReviewBannerComponent, AsyncPipe]
})
