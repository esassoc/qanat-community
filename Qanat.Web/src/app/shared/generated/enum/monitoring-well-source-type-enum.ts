...
export const MonitoringWellSourceTypesAsSelectDropdownOptions = MonitoringWellSourceTypes.map((x) => ({ Value: x.Value, Label: x.DisplayName } as SelectDropdownOption));
