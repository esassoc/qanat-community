...
export const ParcelStatusesAsSelectDropdownOptions = [{ Value: null, Label: "- Select -", Disabled: true }, ...ParcelStatuses.map((x) => ({ Value: x.Value, Label: x.DisplayName } as SelectDropdownOption))];
