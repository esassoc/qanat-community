...
export class FrequentlyAskedQuestionSimpleDto { 
...
export interface FrequentlyAskedQuestionSimpleDtoForm { 
    FrequentlyAskedQuestionID?: FormControl<number>;
    QuestionText?: FormControl<string>;
    AnswerText?: FormControl<string>;
}

export class FrequentlyAskedQuestionSimpleDtoFormControls { 
