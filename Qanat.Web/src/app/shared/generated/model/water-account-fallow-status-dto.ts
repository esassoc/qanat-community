...
export class WaterAccountFallowStatusDto { 
    WaterAccountFallowStatusID?: number | null;
    ...
    readonly CountOfFallowedUsageLocations?: number;
    readonly AcresFallowed?: number;
...
export interface WaterAccountFallowStatusDtoForm { 
    WaterAccountFallowStatusID?: FormControl<number>;
    ...
    CountOfFallowedUsageLocations?: FormControl<number>;
    AcresFallowed?: FormControl<number>;
...
export class WaterAccountFallowStatusDtoFormControls { 
    public static WaterAccountFallowStatusID = (value: FormControlState<number> | number = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<number>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
    ...
    public static CountOfFallowedUsageLocations = (value: FormControlState<number> | number = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<number>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
    ...
    public static AcresFallowed = (value: FormControlState<number> | number = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<number>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
