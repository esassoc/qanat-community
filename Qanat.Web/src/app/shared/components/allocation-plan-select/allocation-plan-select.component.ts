...
@Component({
    ...
    imports: [ButtonGroupComponent, RouterLinkActive, RouterLink, RouterOutlet, AsyncPipe]
})
export class AllocationPlanSelectComponent implements OnInit, OnChanges {
    ...
    ngOnInit(): void {
        //this.getDescription(this.geographyID);
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes.geographyID && changes.geographyID.currentValue) {
            this.getDescription(changes.geographyID.currentValue);
        }
    }

    getDescription(geographyID: number) {
        this.allocationPlansDescription$ = this.publicService.getAllocationPlanConfigurationDescriptionByGeographyIDPublic(geographyID);
    }
