...
USING (VALUES
	(1, 'CalculateEffectivePrecipByZone', 'Calculate Effective Precip By Zone'),
	(2, 'CalculateSurfaceWaterConsumption', 'Calculate Surface Water Consumption'),
	...
	(10, 'CalculateConsumedGroundwater', 'Calculate Consumed Groundwater'),
	(11, 'CalculateEffectivePrecipByScalarValue', 'Calculate Effective Precip By Scalar Value'),
	(12, 'CoverCropAdjustment', 'Cover Crop Adjustment')
)
