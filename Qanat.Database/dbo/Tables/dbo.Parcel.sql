...
CREATE INDEX IX_Parcel_GeographyID on dbo.Parcel(GeographyID);
GO

CREATE INDEX IX_Parcel_WaterAccountID on dbo.Parcel(WaterAccountID);
GO

CREATE INDEX IX_Parcel_ParcelStatusID on dbo.Parcel(ParcelStatusID);
GO