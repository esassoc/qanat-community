...
CREATE INDEX IX_ParcelHistory_GeographyID on dbo.ParcelHistory(GeographyID);
GO

CREATE INDEX IX_ParcelHistory_ParcelID on dbo.ParcelHistory(ParcelID);
GO

CREATE INDEX IX_ParcelHistory_ParcelStatusID on dbo.ParcelHistory(ParcelStatusID);
GO

CREATE INDEX IX_ParcelHistory_UpdateUserID on dbo.ParcelHistory(UpdateUserID);
GO