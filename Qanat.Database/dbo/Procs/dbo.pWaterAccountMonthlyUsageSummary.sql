...
from 
(
    select ParcelID, ParcelNumber, ParcelArea, UsageEntityArea, EffectiveDate, WaterMeasurementTypeID, WaterMeasurementTypeName, WaterMeasurementCategoryTypeDisplayName as WaterMeasurementCategoryTypeName, WaterMeasurementTypeSortOrder
    from 
    #waterAccountParcels
