...
namespace Qanat.EndpointTests.Tests.Watershed
{
    ...
    {
        [DataTestMethod]
        public async ThreadingTask CannotPostWithoutPermission()
        {
            ...
            var result = await APIHelper.Post<BoundingBoxDto>(_validTokenWithoutPermission, route, JsonConvert.SerializeObject(watershedIDListDto));
