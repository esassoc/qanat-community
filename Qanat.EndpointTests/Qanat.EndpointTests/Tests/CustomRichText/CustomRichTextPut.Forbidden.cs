...
namespace Qanat.EndpointTests.Tests.CustomRichText
{
    public partial class CustomRichTextPut
    {
        [DataTestMethod]
        [DataRow(1)]
        public async ThreadingTask CannotPutWithoutPermission(int customRichTextTypeID)
        {
            ...
            var putResult = await APIHelper.Put<CustomRichTextDto>(_validTokenWithoutPermission, route, JsonConvert.SerializeObject(customRichTextDto));
