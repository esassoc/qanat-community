...
namespace Qanat.EndpointTests.Tests.CustomPage
{
    ...
    {
        [DataTestMethod]
        public async ThreadingTask CannotPutCustomPageWithoutPermission()
        {
            ...
            var putResult = await APIHelper.Put<CustomPageDto>(_validTokenWithoutPermission, putRoute, JsonConvert.SerializeObject(customPageUpsertDto));
