...
namespace Qanat.EndpointTests.Tests.CustomPage
{
    ...
    {
        [DataTestMethod]
        public async ThreadingTask CannotPostCustomPageWithoutPermission()
        {
            ...
            var postResult = await APIHelper.Post<CustomPageDto>(_validTokenWithoutPermission, postRoute, JsonConvert.SerializeObject(customPageUpsertDto));
            Assert.AreEqual(HttpStatusCode.Forbidden, postResult.HttpResponseMessage.StatusCode);
