...
namespace Qanat.EndpointTests.Tests.FieldDefinition
{
    public partial class FieldDefinitionPut
    {
        [DataTestMethod]
        [DataRow(1)]
        public async ThreadingTask CanPutWithValidToken(int fieldDefinitionTypeID)
        {
            ...
            var putResult = await APIHelper.Put<FieldDefinitionDto>(_validTokenWithPermission, route, JsonConvert.SerializeObject(fieldDefinitionDto));
