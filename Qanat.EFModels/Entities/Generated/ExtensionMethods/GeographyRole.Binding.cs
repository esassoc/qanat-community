...
namespace Qanat.EFModels.Entities
{
    ...
    public partial class GeographyRoleWaterManager : GeographyRole
    {
        ...
        public static readonly GeographyRoleWaterManager Instance = new GeographyRoleWaterManager(1, @"WaterManager", @"Water Manager", @"", 10, @"{""UserRights"":15,""WaterAccountRights"":15,""ParcelRights"":15,""WellRights"":15,""WaterTransactionRights"":15,""GETActionRights"":15,""ReportingPeriodRights"":15,""WaterTypeRights"":15, ""ExternalMapLayerRights"": 15, ""WaterAccountUserRights"": 15, ""ZoneGroupRights"": 15, ""MonitoringWellRights"":15, ""AllocationPlanRights"": 15, ""GeographyRights"": 15, ""CustomAttributeRights"": 15, ""UsageEntityRights"": 1}", @"{""HasManagerDashboard"":true,""CanReviewWells"":true, ""CanUseScenarioPlanner"":true}");
    }
