...
namespace Qanat.EFModels.Entities
{
    ...
    public partial class RoleSystemAdmin : Role
    {
        ...
        public static readonly RoleSystemAdmin Instance = new RoleSystemAdmin(1, @"SystemAdmin", @"System Administrator", @"", 30, @"{""CustomRichTextRights"":15,""FieldDefinitionRights"":15,""FileResourceRights"":15,""UserRights"":15,""WaterAccountRights"":15,""ParcelRights"":15,""TagRights"":15,""WellRights"":15,""WaterTransactionRights"":15,""ReportingPeriodRights"":15,""WaterTypeRights"":15,""GeographyRights"":15, ""ExternalMapLayerRights"":15, ""WaterAccountUserRights"": 15, ""ZoneGroupRights"": 15, ""MonitoringWellRights"":15, ""AllocationPlanRights"": 15, ""FrequentlyAskedQuestionRights"": 15, ""CustomAttributeRights"": 15, ""UsageEntityRights"": 15}", @"{""CanImpersonateUsers"":true,""HasManagerDashboard"":true,""IsSystemAdmin"":true,""CanClaimWaterAccounts"":true,""CanRegisterWells"":true,""CanReviewWells"":true, ""CanUseScenarioPlanner"":true}");
    }
    ...
    public partial class RoleNoAccess : Role
    {
        ...
        public static readonly RoleNoAccess Instance = new RoleNoAccess(2, @"NoAccess", @"No Access", @"", 10, @"{""CustomRichTextRights"":0,""FieldDefinitionRights"":0,""FileResourceRights"":0,""UserRights"":0,""WaterAccountRights"":0,""ParcelRights"":0,""TagRights"":0,""WellRights"":0,""WaterTransactionRights"":0,""ReportingPeriodRights"":0,""WaterTypeRights"":0,""GeographyRights"":0, ""ExternalMapLayerRights"":0, ""WaterAccountUserRights"": 0, ""ZoneGroupRights"": 0, ""MonitoringWellRights"": 0, ""AllocationPlanRights"": 0, ""FrequentlyAskedQuestionRights"": 1, ""CustomAttributeRights"": 0, ""UsageEntityRights"": 0}", @"{""CanImpersonateUsers"":false,""HasManagerDashboard"":false,""IsSystemAdmin"":false,""CanClaimWaterAccounts"":false,""CanRegisterWells"":false,""CanReviewWells"":false, ""CanUseScenarioPlanner"":false}");
    }
    ...
    public partial class RoleNormal : Role
    {
        ...
        public static readonly RoleNormal Instance = new RoleNormal(3, @"Normal", @"Normal", @"", 20, @"{""CustomRichTextRights"":1,""FieldDefinitionRights"":1,""FileResourceRights"":1,""UserRights"":1,""WaterAccountRights"":0,""ParcelRights"":0,""TagRights"":0,""WellRights"":0,""WaterTransactionRights"":0,""ReportingPeriodRights"":0,""WaterTypeRights"":0,""GeographyRights"":1, ""ExternalMapLayerRights"":0, ""WaterAccountUserRights"": 0, ""ZoneGroupRights"": 1, ""MonitoringWellRights"": 0, ""AllocationPlanRights"": 0, ""FrequentlyAskedQuestionRights"": 1, ""CustomAttributeRights"": 0, ""UsageEntityRights"": 0}", @"{""CanImpersonateUsers"":false,""HasManagerDashboard"":false,""IsSystemAdmin"":false,""CanClaimWaterAccounts"":true,""CanRegisterWells"":true,""CanReviewWells"":false, ""CanUseScenarioPlanner"":false}");
    }
    ...
    public partial class RolePendingLogin : Role
    {
        ...
        public static readonly RolePendingLogin Instance = new RolePendingLogin(4, @"PendingLogin", @"Pending Login", @"", 10, @"{""CustomRichTextRights"":0,""FieldDefinitionRights"":0,""FileResourceRights"":0,""UserRights"":0,""WaterAccountRights"":0,""ParcelRights"":0,""TagRights"":0,""WellRights"":0,""WaterTransactionRights"":0,""ReportingPeriodRights"":0,""WaterTypeRights"":0,""GeographyRights"":0, ""ExternalMapLayerRights"":0, ""WaterAccountUserRights"": 0, ""ZoneGroupRights"": 0, ""MonitoringWellRights"": 0, ""AllocationPlanRights"": 0, ""FrequentlyAskedQuestionRights"": 1, ""CustomAttributeRights"": 0, ""UsageEntityRights"": 0}", @"{""CanImpersonateUsers"":false,""HasManagerDashboard"":false,""IsSystemAdmin"":false,""CanClaimWaterAccounts"":false,""CanRegisterWells"":false,""CanReviewWells"":false, ""CanUseScenarioPlanner"":false}");
    }
}